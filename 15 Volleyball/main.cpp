...
int main()
{
    ...
    sPlayer.setOrigin(Vector2f(75/2,90/2));
    sBall.setOrigin(Vector2f(32,32));
    ...
    {    
        ...
        if (Keyboard::isKeyPressed(Keyboard::Key::Right))  vel.x=5;
        if (Keyboard::isKeyPressed(Keyboard::Key::Left))   vel.x=-5;
        if (Keyboard::isKeyPressed(Keyboard::Key::Up))    if (pos.y*SCALE>=463)  vel.y=-13;
        ...
        if (Keyboard::isKeyPressed(Keyboard::Key::D))  vel.x=5;
        if (Keyboard::isKeyPressed(Keyboard::Key::A))  vel.x=-5;
        if (Keyboard::isKeyPressed(Keyboard::Key::W))    if (pos.y*SCALE>=463)  vel.y=-13;
        ...
        for (b2Body* it = World.GetBodyList(); it != 0; it = it->GetNext())
        {
            ...
            {    
                sPlayer.setPosition(Vector2f(pos.x*SCALE,pos.y*SCALE));
                sPlayer.setRotation(degrees(angle*DEG));
            ...
            {                
                sBall.setPosition(Vector2f(pos.x*SCALE,pos.y*SCALE));
                sBall.setRotation(degrees(angle*DEG));
                window.draw(sBall);    
            }    
        }
