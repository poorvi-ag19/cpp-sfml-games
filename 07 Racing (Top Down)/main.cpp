...
int main()
{
    ...
    sBackground.scale(Vector2f(2,2));

    sCar.setOrigin(Vector2f(22, 22));
    float R=22;
   ...
   int offsetX=0,offsetY=0;
    ...
    sBackground.setPosition(Vector2f(-offsetX,-offsetY));
    ...
    for(int i=0;i<N;i++)
    {
      sCar.setPosition(Vector2f(car[i].x-offsetX,car[i].y-offsetY));
      sCar.setRotation(degrees(car[i].angle*180/3.141593f));
